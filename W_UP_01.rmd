...
The p-value is 0.000009421, the df value is 27.079, and the t-value is -5.4341. Our alternative hypothesis is shown and states true differences in means between group LINE and group SKILL is not equal to 0. Our sample estimates are: mean in group LINE is 17.12500; mean in group SKILL is 49.72. If our null hypothesis is true, the p value is the probability of getting our results. LINE vs SKILL. The p-value is so small that it would ignore the null hypothesis and if it were to be greater than .05, you did not reject the null hypothesis. If you reject the null hypothesis, it's possible that the SKILL group can do more push-ups.
